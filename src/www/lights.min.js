...
function getBridgeIp(a,c){var b=new XMLHttpRequest;b.onreadystatechange=function(){if(4===this.readyState&&200===this.status){var b=JSON.parse(this.responseText);"function"===typeof a&&a(b)}};b.onerror=function(){"function"===typeof c&&c(this)};b.open("GET","https://www.meethue.com/api/nupnp");b.send()}
